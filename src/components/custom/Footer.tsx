...
const Footer = () => {
  return (
    <>
      <div className="pt-8 bg-[#001F14] border-t border-[#285F50] backdrop-blur-sm">
        <div className="h-full  md:h-[120px] bg-[#001F14] relative">
          ...
          <div className="flex justify-between items-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col gap-2">
              ...
              <div className="font-inter text-sm text-gray-500 text-wrap max-w-lg">
